                ...
                (async function poll(){
                    ...
                    if(!include.cache.css[file]){
                        if(file.match(/(^https?)|(^\/\/)/)){
                            ...
                            response = await fetch(dir+file+".css?v="+version);
                        }
                        response = await response.text();
                        text += response
                        text +="\n";
                        include.cache.css[file] = response;
                    }else{
                ...
                (async function poll(){
                    ...
                    if(!include.cache.js[file]){
                        if(file.match(/(^https?)|(^\/\/)/)){
                            ...
                            response = await fetch(dir+file+".js?v="+version);
                        }
                        response = await response.text();
                        text += response
                        text +="\n";
                        include.cache.js[file] = response;
                    }else{
...
Components.$init("/Footer",function(){
...
Components.$init("/PrimaryButton",function(){
